...
public class HourAppUsageRecyclerViewAdapter extends
  UltimateViewAdapter<HourAppUsageRecyclerViewAdapter.SimpleAdapterViewHolder> {
  ...
  public HourAppUsageRecyclerViewAdapter(ArrayList<JSONObject> _appUsageList, Context context) {
...
//      }
  ...
  public SimpleAdapterViewHolder onCreateViewHolder(ViewGroup parent) {
    View v = LayoutInflater.from(parent.getContext())
                            .inflate(R.layout.hour_app_usage_recycler_view_adapter, parent, false);
